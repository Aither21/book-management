...
const SidePanel = () => {
	...
	const [toBorrowState, setToBorrowState] = useState('/admin/book/borrow/list');
						...
						<div className="overflow-y-auto bg-gray-50 rounded dark:bg-gray-800 py-1">
							<ul className="space-y-2">
								...
								<li className={navState}>
										<a href={toBorrowState} className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
								...
								<li className={navState}>
										<a href={toLentState} className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
											...
											<span className="flex-1 ml-3 whitespace-nowrap">貸出中</span>
										</a>
								</li>
								<li className={navState}>
