	...
	switch(props.display){
					...
					<aside className="w-48" aria-label="Sidebar">
						<div className="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
								<ul className="space-y-2">
									...
									<li onClick={props.allButton}>
											<a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
												<svg aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
												<span className="flex-1 ml-3 whitespace-nowrap">全ての本</span>
											</a>
									</li>
									<li>
											<a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
									...
									<li>
											<a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
												...
												<span className="flex-1 ml-3 whitespace-nowrap">ログイン</span>
											</a>
									</li>
									<li>
											<a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
		...
		case 'RETURN':
			return (
				...
				// <div className="fixed left-0 flex-col">
				// 	<div className="flex flex-col">
				// 		<button className="p-2 border" onClick={props.lentButton}>貸出中リスト</button>
				// 		<button className="p-2 border">返却申請リスト</button>
				// 		<button className="p-2 border" onClick={props.allButton}>全書籍リスト</button>
				// 	</div>
				// </div>
			);
		...
		case 'ALL':
			return (
				...
				// 		<button className="p-2 border" onClick={props.lentButton}>貸出中リスト</button>
				// 		<button className="p-2 border" onClick={props.returnButton}>返却申請リスト</button>
				// 		<button className="p-2 border">全書籍リスト</button>
				// 	</div>
				// </div>
			);
			break;
